...
// IDictionary is an interface that represents a collection of key-value pairs, allowing fast access to data using unique keys.
// It provides methods like Add, Remove, and ContainsKey, making it ideal for lookup-based operations.
