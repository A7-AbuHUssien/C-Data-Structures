...
// IComparable is an interface that defines a method for comparing objects, enabling custom sorting and ordering.
// By implementing it, objects can be compared based on defined criteria, which is essential for sorting collections in C#.
